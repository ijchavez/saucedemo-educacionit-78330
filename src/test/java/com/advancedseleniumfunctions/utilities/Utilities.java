...
public class Utilities {
	...
	public static void setNetworkConditions(WebDriver driver, boolean hasInternet, ConnectionType connectionType) {
		DevTools devTools = ((HasDevTools) driver).getDevTools();
		devTools.createSession();
		devTools.send(
				Network.emulateNetworkConditions(hasInternet, 
						300,
						75000,
						25000,
